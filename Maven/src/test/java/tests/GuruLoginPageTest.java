...
public class GuruLoginPageTest extends BaseClass {
	...
	public void VerifyLoginSection(String username, String password, String testCaseName) throws InterruptedException {
		...
		if (isAlertPresent(driver)) {
			...
			System.out.println(manager.getManagerId().getText());
			if (manager.getManagerId().getText().contains(username)) {
